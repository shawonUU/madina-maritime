        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-14 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
            ...
            <div>
              ...
              <div className="mb-4 flex items-center gap-3 text-sm font-bold uppercase tracking-[0.2em] text-teal-700">
                <Leaf size={17} />
                05 — Sustainability
              </div>
              ...
              <p className="mt-6 max-w-xl leading-7 text-slate-600">
                We believe responsible maritime operations should create
                value not only for today, but also for the generations
                that follow.
              </p>

              <Button
                
                className="mt-8 rounded-full bg-[#06245a] px-7 hover:bg-blue-800"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {[
                ["01", "Responsible Operations"],
                ["02", "Resource Efficiency"],
                ["03", "Safety & People"],
                ["04", "Long-Term Thinking"],
              ].map(([number, title]) => (
                <div
                  key={number}
                ...
                >
                  ...
                  <div className="mt-8 font-bold text-[#06245a]">
                    {title}
                  </div>
                </div>
              ))}
